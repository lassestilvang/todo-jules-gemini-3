...
const isBunTest = (typeof (globalThis as unknown as { Bun: unknown }).Bun !== 'undefined') && process.env.NODE_ENV === 'test';
...
if (isBunTest) {
    ...
    // ⚡ Bolt: Enable WAL mode and optimize synchronization for better concurrency and performance
